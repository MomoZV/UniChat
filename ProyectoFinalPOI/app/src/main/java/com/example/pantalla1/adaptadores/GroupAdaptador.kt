...
class GroupAdaptador(private var listaGrupos: MutableList<Grupo>, private var mycontext:Context, private var usuario:String):
    RecyclerView.Adapter<GroupAdaptador.GrupoViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GroupAdaptador.GrupoViewHolder {
        return GroupAdaptador.GrupoViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.group_dessign, parent, false)
        )
    }
    override fun onBindViewHolder(holder: GroupAdaptador.GrupoViewHolder, position: Int) {
